...
@click.option('--slack_channel', default=None, help='Slack channel')
@click.option('--slack_username', default='Deployer', help='Slack channel')
@click.option('--deploy_script', default='./deploy.sh', help='Execute after download and unpack artifact')
@click.option('--last_job_file', default='./last.job', help='Last job file')
